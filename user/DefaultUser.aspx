...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <h2 style="padding-top:2%; padding-left:2%;">Top wines 2023 :</h2>
        ...
        <i class="fa fa-plus my-float" style="margin-top:22px; font-size:2em;">Add comment to a wine</i>
        </a>
...
WHERE rank = 6;"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT TOP 3 * FROM wine ORDER BY rank;">
        </asp:SqlDataSource>
</asp:Content>
