<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageVigneron.master" AutoEventWireup="true" CodeFile="Addwine.aspx.cs" Inherits="Addwine" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [wine]"></asp:SqlDataSource>
