<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="adminVine.aspx.cs" Inherits="Default3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [vine] WHERE [name] = @original_name AND (([type] = @original_type) OR ([type] IS NULL AND @original_type IS NULL)) AND (([domaine] = @original_domaine) OR ([domaine] IS NULL AND @original_domaine IS NULL)) AND (([description] = @original_description) OR ([description] IS NULL AND @original_description IS NULL)) AND (([price] = @original_price) OR ([price] IS NULL AND @original_price IS NULL)) AND (([rank] = @original_rank) OR ([rank] IS NULL AND @original_rank IS NULL)) AND (([IdImage] = @original_IdImage) OR ([IdImage] IS NULL AND @original_IdImage IS NULL)) AND (([vigneronName] = @original_vigneronName) OR ([vigneronName] IS NULL AND @original_vigneronName IS NULL))" InsertCommand="INSERT INTO [vine] ([name], [type], [domaine], [description], [price], [rank], [IdImage], [vigneronName]) VALUES (@name, @type, @domaine, @description, @price, @rank, @IdImage, @vigneronName)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [vine]" UpdateCommand="UPDATE [vine] SET [type] = @type, [domaine] = @domaine, [description] = @description, [price] = @price, [rank] = @rank, [IdImage] = @IdImage, [vigneronName] = @vigneronName WHERE [name] = @original_name AND (([type] = @original_type) OR ([type] IS NULL AND @original_type IS NULL)) AND (([domaine] = @original_domaine) OR ([domaine] IS NULL AND @original_domaine IS NULL)) AND (([description] = @original_description) OR ([description] IS NULL AND @original_description IS NULL)) AND (([price] = @original_price) OR ([price] IS NULL AND @original_price IS NULL)) AND (([rank] = @original_rank) OR ([rank] IS NULL AND @original_rank IS NULL)) AND (([IdImage] = @original_IdImage) OR ([IdImage] IS NULL AND @original_IdImage IS NULL)) AND (([vigneronName] = @original_vigneronName) OR ([vigneronName] IS NULL AND @original_vigneronName IS NULL))">
        <DeleteParameters>
