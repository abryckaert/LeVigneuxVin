...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [review] WHERE [reviewTitle] = @original_reviewTitle AND (([date] = @original_date) OR ([date] IS NULL AND @original_date IS NULL)) AND (([description] = @original_description) OR ([description] IS NULL AND @original_description IS NULL)) AND (([userNickname] = @original_userNickname) OR ([userNickname] IS NULL AND @original_userNickname IS NULL)) AND (([score] = @original_score) OR ([score] IS NULL AND @original_score IS NULL)) AND (([reviewId] = @original_reviewId) OR ([reviewId] IS NULL AND @original_reviewId IS NULL)) AND (([wineName] = @original_wineName) OR ([wineName] IS NULL AND @original_wineName IS NULL))" InsertCommand="INSERT INTO [review] ([reviewTitle], [date], [description], [userNickname], [score], [reviewId], [wineName]) VALUES (@reviewTitle, @date, @description, @userNickname, @score, @reviewId, @wineName)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [review]" UpdateCommand="UPDATE [review] SET [date] = @date, [description] = @description, [userNickname] = @userNickname, [score] = @score, [reviewId] = @reviewId, [wineName] = @wineName WHERE [reviewTitle] = @original_reviewTitle AND (([date] = @original_date) OR ([date] IS NULL AND @original_date IS NULL)) AND (([description] = @original_description) OR ([description] IS NULL AND @original_description IS NULL)) AND (([userNickname] = @original_userNickname) OR ([userNickname] IS NULL AND @original_userNickname IS NULL)) AND (([score] = @original_score) OR ([score] IS NULL AND @original_score IS NULL)) AND (([reviewId] = @original_reviewId) OR ([reviewId] IS NULL AND @original_reviewId IS NULL)) AND (([wineName] = @original_wineName) OR ([wineName] IS NULL AND @original_wineName IS NULL))">
    <DeleteParameters>
        ...
        <asp:Parameter Name="original_wineName" Type="String" />
    </DeleteParameters>
    <InsertParameters>
